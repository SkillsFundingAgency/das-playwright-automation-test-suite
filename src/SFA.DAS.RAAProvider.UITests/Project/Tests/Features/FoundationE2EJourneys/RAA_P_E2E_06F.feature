...
@raaprovidere2e
@regression
Scenario: RAA_P_E2E_06 - Create a foundation vacancy with registered name, Approve, Apply, receive email notifications and make Application Successful
