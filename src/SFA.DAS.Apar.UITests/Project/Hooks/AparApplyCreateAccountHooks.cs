...
public class AparApplyCreateAccountHooks : AparBaseHooks
{
    private readonly ScenarioContext _context;
    private readonly AparApplyContactSqlDbHelper _roatpApplyContactSqlDbHelper;
    private AparApplyCreateUserDataHelper _applydataHelpers;

    public AparApplyCreateAccountHooks(ScenarioContext context) : base(context)
    {
        _context = context;
        _roatpApplyContactSqlDbHelper = new AparApplyContactSqlDbHelper(_objectContext, _dbConfig);
    }
    ...
    public async Task ClearDownData()
    {
        ...
        _applydataHelpers = _context.Get<AparApplyCreateUserDataHelper>();
