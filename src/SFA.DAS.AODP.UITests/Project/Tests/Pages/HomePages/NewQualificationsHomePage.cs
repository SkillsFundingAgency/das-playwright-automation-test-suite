...
{
    public class NewQualificationsHomePage(ScenarioContext context) : AoStartPage(context)
    {

        public ILocator NewQualificationsPage => page.Locator("//h2[.=\"New Qualifications\"]");
