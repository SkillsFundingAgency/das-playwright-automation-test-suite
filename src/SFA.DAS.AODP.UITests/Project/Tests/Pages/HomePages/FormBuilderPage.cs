...
namespace SFA.DAS.AODP.UITests.Project.Tests.Pages.DfE
{
...

    {
        ...
        public ILocator FormBuilderButton => page.GetByText("View Forms");
        ...
        private ILocator CreateNewFormBtn => page.GetByText("Create New Form");

        // public override async Task VerifyPage() => await Task.CompletedTask;

        public override async Task VerifyPage() => await Assertions.Expect(page.GetByRole(AriaRole.Heading)).ToHaveTextAsync("View Forms");
        ...
        public async Task NavigateToFormBuilder() => await FormBuilderButton.ClickAsync();
