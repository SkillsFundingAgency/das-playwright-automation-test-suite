...
namespace SFA.DAS.Approvals.UITests.Project.Pages.Provider
{
    internal class FundingRestrictionsPage(ScenarioContext context) : ApprovalsBasePage(context)
    {
        ...
        internal async Task<ConfirmReservationPage> ReserveFundsAsync(string courseName, DateTime reservationStartDate)
        {
            ...
            return await VerifyPageAsync(() => new ConfirmReservationPage(context));
        }
