...
namespace SFA.DAS.Approvals.UITests.Project.Pages.Provider
{
    internal class ApprenticeRequests_ProviderPage(ScenarioContext context) : ApprovalsBasePage(context)
    {
        ...
        internal async Task<ViewLearnerDetails_ProviderPage> OpenNonEditableCohortAsync(string? cohortRef)
        {
            await ClickDetailsLinkAsync(cohortRef);
            return await VerifyPageAsync(() => new ViewLearnerDetails_ProviderPage(context));
        }
