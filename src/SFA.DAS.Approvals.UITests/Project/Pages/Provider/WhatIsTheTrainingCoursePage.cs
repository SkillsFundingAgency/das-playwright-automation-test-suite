...
namespace SFA.DAS.Approvals.UITests.Project.Pages.Provider
{
    internal class WhatIsTheTrainingCoursePage(ScenarioContext context) : ApprovalsBasePage(context)
    {
        ...
        internal async Task<CheckAndConfirmYourReservationPage> ReserveFundsAsync(string courseName, DateTime reservationStartDate)
        {
            ...
            return await VerifyPageAsync(() => new CheckAndConfirmYourReservationPage(context));
        }
