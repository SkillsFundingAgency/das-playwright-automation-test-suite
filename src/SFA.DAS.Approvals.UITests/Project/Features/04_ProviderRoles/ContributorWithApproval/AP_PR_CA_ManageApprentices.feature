@approvals
@pasproviderrole
Feature: AP_PR_CA_ManageApprentices


@regression
@Approvalproviderrole
Scenario: AP_PR_CA_Provider Roles Contributor With Approval Manage Apprentices
	...
	And the user "cannot" edit an existing apprenticeship record by selecting edit apprentice link under manage apprentices