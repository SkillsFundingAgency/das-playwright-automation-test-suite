...
Scenario Outline: AP_AC_03_Validate age checks for the restricted Courses_FileUploadJourney - post approval
	...
	When Employer tries to edit live apprentice record by setting age lower than <LowerAgeLimit>
	Then the employer is stopped with an error message for <LowerAgeLimit>
	When Provider tries to edit live apprentice record by setting age higher than <UpperAgeLimit>
	Then the provider is stopped with an error message for <UpperAgeLimit>
