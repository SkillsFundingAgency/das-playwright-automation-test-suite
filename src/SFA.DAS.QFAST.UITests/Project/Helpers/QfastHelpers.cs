...
{    
    ...
    public async Task<Admin_Page> GoToQfastAdminHomePage()
    {
        ...
        return await VerifyPageHelper.VerifyPageAsync(context, () => new Admin_Page(context));
    }
    ...
    public async Task<IFATE_Page> GoToQfastIFATEHomePage()
    {
        ...
        return await VerifyPageHelper.VerifyPageAsync(context, () => new IFATE_Page(context));
    }
    public async Task<OFQUAL_Page> GoToQfastOFQUALHomePage()
    {
        await new DfeAdminLoginStepsHelper(context).LoginToQfastAsOFQUALUser();

        return await VerifyPageHelper.VerifyPageAsync(context, () => new OFQUAL_Page(context));
    }
