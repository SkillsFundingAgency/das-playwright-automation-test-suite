Feature: Fin_IA_PE_01_PeriodEnds_01_new
...
# @regression
# @innerapi
# Scenario: Fin_IA_PE_01_PeriodEnds_1 Post periods and verify retrieval by list
#     Given remove the existing period end data from DB
#     When period end details are posted via endpoint: api/period-ends
...
# @regression
# @innerapi
# Scenario: Fin_IA_PE_01_PeriodEnds_1 Post periods and verify retrieval by periodEndId
#     Given remove the existing period end data from DB
#     When period end details are posted via endpoint: api/period-ends
