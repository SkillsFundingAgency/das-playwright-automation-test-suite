...
Feature: EmployerDisplayAdvertApi

@api
@regression
@raaapi
@raaapiemployer
Scenario Outline: RAA_API_04_Emp_OuterApiDisplayAdvertApi_Ok
...
@raaapiemployer
@invalidapikey
Scenario Outline: RAA_API_04B_Emp_OuterApiDisplayAdvertApi_Unauthorized
	When the user sends a GET request to <Endpoint>
	Then a <ResponseStatus> response status is received
